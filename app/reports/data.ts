...
export interface ReportMeta {
  ...
  sources?: string[];                  // optional primary-source URLs rendered on the report page
...
const baseReports: ReportMeta[] = [
  ...
  },
  {
    ...
    dateModified: '2026-06-16',
    keywords: [
      'India drone sensors', 'drone payloads India', 'drone imaging systems India', 'LiDAR drones India',
      'thermal imaging drones India', 'germanium-free thermal imaging', 'drone sensor market India', 'drone payload integration',
      'Eon Space Labs', 'drone sensor import dependence', 'drone-as-a-service India', 'multispectral drone sensors',
    ],
    faq: [
      { q: 'How big is India’s drone sensors and payloads market?', a: 'About US$190–210 million in 2026, modelled to reach US$1.1–1.5 billion by 2035 — a 22–26% CAGR. LiDAR is the fastest-growing category at over 35% CAGR, driven by infrastructure inspection, mining volumetrics and corridor mapping.' },
      { q: 'How dependent is India on imported drone sensors?', a: 'Heavily. Roughly 70–80% of high-grade drone-sensor demand is imported — about 85% of LiDAR, 80% of thermal cores and 70% of inertial measurement units — sourced mainly from China, Taiwan and the United States. The localisation gap, not the platform, is where the strategic exposure sits.' },
      ...
      { q: 'Which business model is winning in India’s drone-sensing market?', a: 'Drone-as-a-Service. Value is shifting from selling hardware to monetising the data the sensors capture, with DaaS margins of 50–65% against hardware margins of 25–35%. Buyers increasingly want actionable intelligence — orthomosaics, point clouds, NDVI layers — not raw sensors.' },
      { q: 'Who are the leading players in India’s drone sensor and payload market?', a: 'ideaForge leads on certification and integrated payload ecosystems; Eon Space Labs holds proprietary germanium-free thermal with about 80% localisation; Garuda Aerospace runs the largest agricultural DaaS fleet; and BEL brings defence-PSU radar capability. International suppliers still hold the high-spec LiDAR and thermal cores.' },
    ],
  },
  {
  ...
  },
  {
    ...
    keywords: [
      'who controls India’s drones', 'India flight controller', 'drone autonomy India',
      'flight controller import dependence China', 'GPS-denied navigation', 'electronic warfare drones India',
      'drone PLI scheme 40% localisation', 'indigenous flight controller', 'Zuppa Tsalla ideaForge',
      'RISC-V flight controller', 'counter-UAS India', 'drone control stack', 'MEMS IMU India',
    ],
    faq: [
      { q: 'Does India make its own drone flight controllers?', a: 'Largely no. Official data placed before the Lok Sabha in April 2025 record 39% of flight controllers in DGCA-certified small drones as Chinese-sourced, and across the whole fleet the effective figure is 70–80%. The processors and MEMS inertial sensors at the base of the stack are roughly 100% imported, so even “indigenous” controllers are assembled on foreign silicon.' },
      { q: 'What does the new drone PLI scheme require?', a: 'The new INR 2,000 crore (about USD 240 million) scheme mandates 40% domestic value addition in flight controllers, navigation systems and communication modules by FY2027-28, and for the first time covers autonomy software. Continued reliance on imported Pixhawk-class boards risks both PLI eligibility and government-tender access.' },
      { q: 'Why is the flight controller so strategically important?', a: 'It is the brain of the drone — it decides where the aircraft goes and what it does. Electronic-warfare resilience and GPS-denied navigation depend on it, and Operation Sindoor in May 2025 showed that imported controllers lack the anti-jam and anti-spoof resilience contested environments demand.' },
      { q: 'Which Indian companies lead drone flight control and autonomy?', a: 'ideaForge (listed on the NSE and BSE since 2023) leads the integrated stack; Zuppa holds a patented flight-control architecture; Tsalla is building GPS-denied / EW-resilient autonomy; Inferigence Quotient and Yaanendriya are emerging; and defence primes BEL and Raphe mPhibr anchor the defence segment.' },
      { q: 'What is the hardest part of localising flight controllers?', a: 'The silicon. Flight-control processors and MEMS inertial sensors are roughly 100% imported and a credible indigenous alternative (a RISC-V flight-control system-on-chip) is a five-to-eight-year undertaking. Localisation plateaus near 40% unless the processor layer is addressed or deliberately exempted from the count.' },
    ],
  },
  {
