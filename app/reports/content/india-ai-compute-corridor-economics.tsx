...
/* ───────────────────────────────────────────────────────────────────────────
   India AI Compute Corridor Economics, 2026–2035 — long-form reading edition.
...
const BODY = readFileSync(
  path.join(process.cwd(), 'app', 'reports', 'content', 'india-ai-compute-corridor-economics.body.html'),
  'utf8',
);
