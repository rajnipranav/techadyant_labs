...
/* ───────────────────────────────────────────────────────────────────────────
   India's Military Aerospace Manufacturing Ecosystem — long-form reading edition.
   Rendered as static, server-side HTML so every paragraph, table and figure
   label is crawler- and AI-indexable; the four analytical figures are inlined
...
const BODY = readFileSync(
  path.join(process.cwd(), 'app', 'reports', 'content', 'india-military-aerospace-manufacturing-ecosystem.body.html'),
  'utf8',
);
