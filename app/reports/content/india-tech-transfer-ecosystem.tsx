...
/* ---------------------------------------------------------------------------
   India's Industrial Technology Transfer Ecosystem (2026 Edition) - long-form
   reading edition. Source: the condensed HTML edition (Qwen_html_20260907),
   cleaned for the site: head/styles/JSON-LD/site chrome stripped, sections
   anchored to the reader TOC, figures scoped to .report-figure/.fig-frame,
   prices aligned to the live tiers (\u20b96,999 report / \u20b910,999 report +
   data), purchase CTAs wired to the on-page access panel (#get-report-access).
...
const BODY = readFileSync(
  path.join(process.cwd(), 'app', 'reports', 'content', 'india-tech-transfer-ecosystem.body.html'),
  'utf8',
);
