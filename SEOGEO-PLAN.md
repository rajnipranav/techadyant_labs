...
| 2026-08-15 | Renumbered all 55 cms_signals so `no` matches chronological date order (S-001..S-055); 14 Aug BEL signal now S-052 so newest block reads S-052-S-055 consecutively; sync now orders by date then no; verified in 1,404-page build | Completed | Confirm on live site after Pages deploy | app/signals/data.ts / scripts/renumber-signals.mjs / scripts/sync-cms-to-data.mjs / cms_signals | Hermes + Operator |
| 2026-08-15 | GSC connected (Route A): gsc-report.mjs live, first report (42 clicks / 6,219 impressions / 0.7% CTR, 28d). CTR quick wins applied: India AI report seo.metaTitle+metaDescription via CMS; IREL player description rewritten with OSCOM/Chhatrapur keywords in _atlas.json | Completed | Re-run gsc-report.mjs after deploy to track CTR movement; consider 301 for legacy player slug; wire Ahrefs later | seo-reports/gsc-2026-08-15.md / scripts/gsc-report.mjs / scripts/update-report-seo.mjs / cms_reports / app/research/_atlas.json | Hermes + Operator |
|
